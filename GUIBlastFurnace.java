package com.doggie.RhoduimMod.blocks.machines.blast;
...
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/BlastFurnace.png");
	...
	{
		super(new CBlastFurnace(player, tileentity));
		this.player = player;
